...
<head>
    ...
    <script src="js/updet.js" type="text/javascript" charset="UTF-8"></script>
</head>
<body>
<div id="wrapper">
    <div id="dhl">
    ...
    <div id="admAddPic">
        <form action="admUpDetGo.do?goods_id=${goods_id}" method="post" enctype="multipart/form-data" id="detForm">
            <div class="admAddPic">
                <div>选择图片</div>
            ...
            <div class="admAddPic">
                <div>商品介绍</div>
                <div><textarea name="details_text" id="detText"></textarea></div>
            </div>
            <div class="admAddPic">
                <div>价格介绍</div>
                <div><textarea name="details_price" id="detPic"></textarea></div>
            </div>
            <div class="admAddPic">
                <input type="button" value="提交" width="100px" id="detBtn">
            </div>
        </form>
    </div>
</div>
