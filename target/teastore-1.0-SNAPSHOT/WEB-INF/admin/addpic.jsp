...
<head>
    ...
    <script src="js/addpic.js" type="text/javascript" charset="UTF-8"></script>
</head>
<body>
<div id="wrapper">
    <div id="dhl">
    ...
    <div id="admAddPic">
        <form action="admAddPicGo.do?goods_id=${goods_id}" method="post" enctype="multipart/form-data" id="picForm">
            <div class="admAddPic">
                <div>选择图片</div>
